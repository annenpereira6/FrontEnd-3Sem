   ...
   // ciclos de vida e funcoes
     ...
     async function cadastrarProduto(e) {
       ...
       if (
        ...
        //cadastrar na api
        try {
            const retornoAPI = await api.post("/produto", objCadastro);
    ...
    function limparFormulario() {
     ...
     async function deletar(id) {
        ...
        if(!confirm("Voce realmente deseja apagar o produto?")){
            return false;
        }
        ...
        const objCadastro = {
         ...
         //chamar a api
          try {
            ...
            const retornoAPI = await axios.put(`/produto/${id}`, objCadastro);
